    ...
    <div>
      <table class="table table-condensed">
        ...
        <tr>
          ...
          <td class="text-center"><button type="button" onclick="cart.remove('<?php echo $product['cart_id']; ?>');" title="<?php echo $button_remove; ?>" class="btn btn-danger btn-xs"><i class="fa fa-close"></i></button></td>
        </tr>
        <?php } ?>
